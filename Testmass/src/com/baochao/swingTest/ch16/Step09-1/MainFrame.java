...
{ 
    ...
    public void buildToolBar()
    {
        ...
        button.setIcon(new ImageIcon("icons/_bold.gif"));
        button.setToolTipText((String)action.getValue(Action.NAME));

        action = new StyledEditorKit.ItalicAction();
        action.putValue(Action.NAME, "");
        button = toolBar.add(action);
        button.setIcon(new ImageIcon("icons/_italic.gif"));
        button.setToolTipText((String)action.getValue(Action.NAME));

        action = new StyledEditorKit.UnderlineAction();
        action.putValue(Action.NAME, "");
        button = toolBar.add(action);
        button.setIcon(new ImageIcon("icons/_underline.gif"));
        button.setToolTipText((String)action.getValue(Action.NAME));
        ...
        combo.addActionListener(new HandleFontChoose());
        toolBar.add(combo);
        toolBar.addSeparator();
    ...
    class HandleFontChoose implements ActionListener
    {
